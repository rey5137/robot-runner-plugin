...
import com.github.rey5137.robotrunnerplugin.runconfigurations.RobotOutputConsoleView
...
class OpenOutputFileAction(
    ...
    override fun actionPerformed(e: AnActionEvent) {
        if (processHandler.isProcessTerminated) {
            val outputFilePath = (console.consoleView as ConsoleViewImpl).text.findOutputFilePath()
